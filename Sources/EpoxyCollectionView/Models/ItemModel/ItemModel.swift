...
public struct ItemModel<View: UIView>: @MainActor ViewEpoxyModeled {
...
extension ItemModel: @MainActor ItemModeling {
...
extension ItemModel: @MainActor InternalItemModeling {
...
extension ItemModel: @MainActor CallbackContextEpoxyModeled {
