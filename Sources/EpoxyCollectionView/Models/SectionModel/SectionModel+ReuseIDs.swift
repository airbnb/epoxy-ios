...
extension SectionModel {
  /// Gets all items' view differentiators from this section.
  ...
  /// Gets the supplementary views' view differentiators for each element kind in this section.
...
extension Array where Element == SectionModel {
  ...
  /// Gets the supplementary views' view differentiators for each element kind in these sections.
  public func getSupplementaryViewDifferentiators() -> [String: Set<ViewDifferentiator>] {
    var newViewDifferentiatorsForElementKind = [String: Set<ViewDifferentiator>]()
    for section in self {
